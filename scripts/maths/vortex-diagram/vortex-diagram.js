class Vortex {
    constructor() {
        ...
        this.svgWidth = 400; // px
        this.svgHeight = this.svgWidth; // px
    ...
    svgLine(x1, y1, x2, y2) {
        let myLine = document.createElementNS(
            "http://www.w3.org/2000/svg",
            "line"
        );
    ...
    svgText(x, y, text) {
        let myText = document.createElementNS(
            "http://www.w3.org/2000/svg",
            "text"
        );
